...
const BASE_STATIONS = [
    ...
    { name: "測試基地台#1", lon: 121.5425, lat: 25.0330, power: 82.75 }
];
...
function getRadiusForSignal(strength) {
    ...
    else if (strength >= 70) return 4.75; // 淺綠
    else if (strength >= 50) return 4; // 黃色
    else if (strength >= 30) return 3.25; // 橙色
    else if (strength >= 10) return 2.5; // 紅色
